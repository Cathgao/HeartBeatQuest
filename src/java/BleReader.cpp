...
JNIEXPORT void JNICALL HeartBeat::BleReader::OnDeviceData(JNIEnv *env, jobject thiz, jstring macAddr, jint heartRate, jlong energy){
...
JNIEXPORT jboolean JNICALL HeartBeat::BleReader::InformNativeDevice(JNIEnv *env, jobject thiz, jstring macAddr, jbyteArray name){
...
JNIEXPORT void JNICALL HeartBeat::BleReader::OnAutoConnectStatusChanged(JNIEnv *env, jobject thiz, jboolean autoConnecting){
