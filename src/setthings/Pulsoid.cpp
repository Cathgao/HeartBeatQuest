...
void HeartBeat::PulsoidSettings::CreateElements() {
    ...
    BSML::Lite::CreateUIButton(
        container->get_transform(), SSL10nGen::STR::pulsoid_reconnect(), UnityEngine::Vector2{},
    ...
    BSML::Lite::CreateText(container->get_transform(), SSL10nGen::STR::pulsoid_input_hint(), 4, UnityEngine::Vector2{},
...

    {
        ...
        PairInBrowserBtn = BSML::Lite::CreateUIButton(
            pair_container->get_transform(), SSL10nGen::STR::pulsoid_connect(), UnityEngine::Vector2{},
        ...
        BrowserCompleteBtn = BSML::Lite::CreateUIButton(
            pair_container->get_transform(), SSL10nGen::STR::pulsoid_done(), UnityEngine::Vector2{},
            UnityEngine::Vector2{20, 8}, [this]() {
                setButtonBusying();
        ...
        CancelBrowserPairBtn = BSML::Lite::CreateUIButton(
            pair_container->get_transform(), SSL10nGen::STR::pulsoid_cancel(), UnityEngine::Vector2{},
            UnityEngine::Vector2{20, 8}, [this]() {
    ...
    BSML::Lite::CreateText(container->get_transform(), SSL10nGen::STR::pulsoid_token(), 4, UnityEngine::Vector2{},
                           UnityEngine::Vector2{50, 4});
    tokenText =
        BSML::Lite::CreateText(container->get_transform(), "", 4, UnityEngine::Vector2{}, UnityEngine::Vector2{50, 4});
    BSML::Lite::CreateUIButton(
        container->get_transform(), SSL10nGen::STR::pulsoid_clear_token(), UnityEngine::Vector2{},
    ...
    {
        std::string config_file_hint = SSL10nGen::STR::pulsoid_edit_config_hint() + modConfigFilePath;
        char buff[1024];
        int j = 0;
